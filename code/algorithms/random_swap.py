...
## After random connecting:
# Free up battery with most remainder left by removing houses with maxoutput lower than remainders of other batteries
# Connect these houses to other batteries (random) ------ NEXT OPTIMIZATION: MAKE THIS NOT RANDOM
# then start connecting again for the houses that are not connected
